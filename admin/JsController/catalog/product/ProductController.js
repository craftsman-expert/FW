...
function ProductController() {
    ...
    this.add = function (form) {
        let url = new URL(baseUrl + '/admin/method/product.add');
    ...
    this.update = function (form) {
        let url = new URL(baseUrl + '/admin/method/product.update');
    ...
    this.delete = function (id, lang = false) {
        let url = new URL(baseUrl + '/admin/method/product.delete');
