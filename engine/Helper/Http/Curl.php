...
class Curl
{
    ...
    public function __construct ($options = [])
    {
        ...
        $this->setOption(CURLOPT_COOKIEJAR,         $_SERVER['DOCUMENT_ROOT'].'/cookie.txt');
        $this->setOption(CURLOPT_COOKIEFILE,        $_SERVER['DOCUMENT_ROOT'].'/cookie.txt');
